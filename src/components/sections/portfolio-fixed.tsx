...
// ✅ FIX #1: محسّن معالجة أخطاء الصور
const ImageWithFallback = ({ 
  ...
  if (!src || hasError) {
    return (
      <div className={`${className} flex items-center justify-center bg-gradient-to-br from-muted/50 to-muted/30`}>
        {FallbackIcon ? (
          <FallbackIcon className="size-12 text-muted-foreground/30" />
        ) : (
                ...
                {currentProjects.map((project, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {/* Image - ✅ FIX #1: استخدام ImageWithFallback */}
                        <div
        ...
        {selectedProject && (
          ...
          >
            ...
            >
              ...
              {/* Main image - ✅ FIX #1: استخدام ImageWithFallback */}
              <div
              ...
              >
                ...
                {!modalImgError && selectedProject.imageUrl && (
                  <ImageWithFallback
                    ...
                    fallbackIcon={selectedProject.icon}
                    isRtl={isRtl}
                  />
                )}
              </div>
              ...
              <div className="p-5 sm:p-6 space-y-5">
                ...
                {/* Gallery - ✅ FIX #1: معالجة أفضل للصور المفقودة */}
                <div className="space-y-3">
                  ...
                  <div className="flex gap-3 overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-2" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                    {[1, 2, 3].map((n) => {
                      ...
                      const galleryUrl = n === 1 ? selectedProject.gallery1 : n === 2 ? selectedProject.gallery2 : selectedProject.gallery3
